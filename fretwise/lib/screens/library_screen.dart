            ...
            child: Listener(
              ...
              child: GestureDetector(
                ...
                onHorizontalDragUpdate: (d) {
                  ...
                  setState(() {
                    _offset = (_dragStartOffset + dx).clamp(-72.0, 0.0);
                  });
                },
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (widget.song.progressPercent > 0) ...[
                          const SizedBox(height: 12),
                          ProgressBar(
                            progress: widget.song.progressPercent / 100,
                            t: t,
                            height: 4,
                          ),
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                widget.song.progressPercent == 100
                                    ? 'Completed'
                                    : 'In progress',
                                style: TextStyle(
                                  fontSize: 11,
                                  color: widget.song.progressPercent == 100
                                      ? AppColors.green
                                      : t.textMuted,
                                ),
                              ),
                              Text(
                                '${widget.song.progressPercent}%',
                                style: TextStyle(
                                  fontSize: 11,
                                  color: t.textMuted,
                                ),
